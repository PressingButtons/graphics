...
import VAOGener from "$lib/glib/vaogener";
import ShaderProgram from "../shaderprogram";
import { fragment, vertex } from "./source.palette";

export default function generatePaletteShader( gl: WebGL2RenderingContext, model: WebGLBuffer, transform: WebGLBuffer ) {
